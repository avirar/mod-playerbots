...
uint32 WorldPosition::getMapId() const { return GetMapId(); }

float WorldPosition::getX() const { return GetPositionX(); }

float WorldPosition::getY() const { return GetPositionY(); }

float WorldPosition::getZ() const { return GetPositionZ(); }

float WorldPosition::getO() const { return GetOrientation(); }
