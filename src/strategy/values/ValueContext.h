...
public:
    ValueContext()
    {
        ...
        creators["nearest quest npcs"] = &ValueContext::nearest_quest_npcs;
...
private:
    ...
    static UntypedValue* nearest_quest_npcs(PlayerbotAI* botAI) { return new NearestQuestNpcsValue(botAI); }
