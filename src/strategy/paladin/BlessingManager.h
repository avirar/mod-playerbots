...
inline static std::map<int, std::map<uint8 /*classId*/, std::vector<GreaterBlessingType>>> BlessingTemplates =
{
    ...
    // 4 Paladins: Sanctuary always first, Kings always last
    {
        4,
        {
            { CLASS_WARRIOR,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            ...
            { CLASS_ROGUE,         { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            ...
            { CLASS_DEATH_KNIGHT,  { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
