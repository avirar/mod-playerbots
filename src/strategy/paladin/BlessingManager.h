...
inline static std::map<int, std::map<uint8 /*classId*/, std::vector<GreaterBlessingType>>> BlessingTemplates =
{
    ...
    // 3 Paladins: Sanctuary prioritized, Kings always last
    {
        3,
        {
            { CLASS_WARRIOR,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_PALADIN,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            ...
            { CLASS_PRIEST,        { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_DEATH_KNIGHT,  { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_SHAMAN,        { GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_MAGE,          { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_WARLOCK,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_DRUID,         { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } }   
        }
    },
    // 4 Paladins: Sanctuary always first, Kings always last
    {
        4,
        {
            { CLASS_WARRIOR,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS, GREATER_BLESSING_OF_WISDOM } },  
            { CLASS_PALADIN,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_HUNTER,        { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_ROGUE,         { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS, GREATER_BLESSING_OF_WISDOM } },  
            { CLASS_PRIEST,        { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_DEATH_KNIGHT,  { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS, GREATER_BLESSING_OF_WISDOM } },  
            { CLASS_SHAMAN,        { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_MAGE,          { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_WARLOCK,       { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } },  
            { CLASS_DRUID,         { GREATER_BLESSING_OF_SANCTUARY, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, GREATER_BLESSING_OF_KINGS } }   
        }
    }
};
