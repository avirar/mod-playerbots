...
struct NewRpgInfo
{
    ...
    struct TravelFlight
    {
        ...
        WorldPosition fromFlightMasterPos{};
        uint32 fromNode{0};
        uint32 toNode{0};
        bool inFlight{false};
    };
    ...
    void ChangeToTravelFlight(ObjectGuid fromFlightMaster, uint32 fromNode, uint32 toNode, WorldPosition fromFlightMasterPos = WorldPosition());
